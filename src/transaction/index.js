...
class Transaction {
   ...
   */
  constructor (format, sender, senderType, recipient, recipientType, value, fee, validityStartHeight, flags, data, proof, networkId = GenesisConfig['main'].NETWORK_ID) {
  ...
  get serializedContentSize () {
    return /* dataSize */ 2 +
          ...
          this._sender.serializedSize /* senderType */ +
          1 +
          this._recipient.serializedSize /* recipientType */ +
          1 /* value */ +
          8 /* fee */ +
          8 /* validityStartHeight */ +
          4 /* networkId */ +
          1 /* flags */ +
          1
  }
   ...
   * @private
   */
  _verify (networkId = GenesisConfig['main'].NETWORK_ID) {
  ...
  hash () {
    ...
    this._hash = this._hash || this.getHash()
    return BufferUtils.toHex(this._hash.serialize())
  }
